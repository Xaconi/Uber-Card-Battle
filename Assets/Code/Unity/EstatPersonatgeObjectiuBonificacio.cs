...
public class EstatPersonatgeObjectiuBonificacio : EstatPersonatge {
	...
	public EstatPersonatgeObjectiuBonificacio(Personatge p){
		personatgeActual = p;
		posicio = personatgeActual.transform.position;
		personatgeActual.gameObject.renderer.enabled = true;
	}

	public void pintarPersonatge(){
		//throw new System.NotImplementedException();
		if(pas < 1.0f) pas += 0.001f;
		personatgeActual.gameObject.renderer.material.color = Color.Lerp(personatgeActual.gameObject.renderer.material.color, Color.blue, pas);
