...
public class AnimacioPantallesBatallaFinal : MonoBehaviour {
	...
	public void Awake(){
		Debug.Log("AWAKE del AnimacioPantallesBatalla");
	...
	public void OnGUI(){
		if(obertura){
			if(pPantalla <= 0.5f)pPantalla += 0.01f;
				...
				// Aqui haig de carregar la pantalla de resultats...
				...
				if(cG.partidaAbandonada) Camera.mainCamera.gameObject.AddComponent("ControlGeneralMenuPrincipal");
				else Camera.mainCamera.gameObject.AddComponent("MenuResultats");
